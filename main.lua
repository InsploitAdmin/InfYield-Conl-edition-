...
Title.TextSize = 18
Title.Text = "Infinite Yield (Conl edition)"
Title.TextColor3 = Color3.new(1, 1, 1)
Title.ZIndex = 10
table.insert(shade1,Title)
table.insert(text1,Title)

local function EKDOA_fake_script()
	local script = Instance.new("LocalScript", Title)
	while wait() do
		script.Parent.TextColor3 = Color3.fromHSV(tick()%5/5,1,1)
	end
end
coroutine.wrap(EKDOA_fake_script)()
...
function teleport(target)
	...
	game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(1, Enum.EasingStyle.Linear), {CFrame = target.Character.HumanoidRootPart.CFrame}):Play()
